...
| [`hakathon_sendbox/`](hakathon_sendbox/) | **Hardware hackathon workspace** — Claude Code setup for DE10-Lite FPGA + ESP32 under a 24h/token-budget constraint. See the [case study](hakathon_sendbox/CASE_STUDY.md). |
