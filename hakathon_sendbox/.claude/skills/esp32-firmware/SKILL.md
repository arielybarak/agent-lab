...
name: esp32-firmware
description: >
  ESP32 firmware on PlatformIO + Arduino: install the toolchain, board
  bring-up, the UART bridge to the DE10-Lite FPGA, LVGL UI, peripherals
  (OLED/servo/sensors), and hard-won build/flash BKMs. Use for any ESP32
  side of a TechCrash 2026 challenge.
---
