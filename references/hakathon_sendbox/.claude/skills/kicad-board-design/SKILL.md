...
description: >
  Design PCBs end-to-end in KiCad 9.x via text-based S-expression files and
  CLI-driven verification: schematic, ERC, layout, copper routing, DRC, and
  Gerber production output. Use for any PCB-design challenge.
---
